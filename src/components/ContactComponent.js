                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            <a role="button" className="btn btn-primary" href="tel:+91 8114488467"><i className="fa fa-phone"></i> Call</a>
                            <a role="button" className="btn btn-info" href="skypeto:Spicy_raj@jeevan.net"><i className="fa fa-skype"></i> Skype</a>
                            <a role="button" className="btn btn-success" href="mailto:Spicy_raj@jeevan.net"><i className="fa fa-envelope-o"></i> Email</a>
                        </div>
                        </div>
                </div>
                        ...
                        <Form model="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    name="telnum"placeholder="Contact no"
                                    className="form-control"
                                    validators={{
